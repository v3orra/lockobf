...
Euleon Leaked. <--- Only for a school prj. (Deleting after it)

Execute: https://github.com/v3orra/lockobf/blob/main/lockpst.lua

Do not copy all of this or it might crash ^-^
...
@ch.rist
 ...
 getgenv().Settings = {
    ...
    Visual = {
        ...
        FovTransparency = 0.1,
        FovThickness = 1,
        FovColor = Color3.fromRGB(255, 0, 127),
        FovRadius = 144
    },
    Spoofer = {
        MemorySpoofer = true,
